...
/* Catatan: EkgConductionPanel + diagram sistem konduksi dipindah ke
   src/components/conduction.tsx agar layar Teori bisa lazy-split dan
   tidak menariknya ke chunk utama. */
