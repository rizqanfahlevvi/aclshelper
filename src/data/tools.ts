...
export const PALS_DRUGS: PalsDrug[] = [
  ...
  },
  {
    ...
    min: 0.1,
    max: 0.5,
    minMax: 'min 0.1 mg; maks 0.5 mg (dosis anak). Remaja/dewasa besar: hingga 1 mg dapat dipertimbangkan sesuai judgment klinis — kalkulator ini TIDAK otomatis melebihi 0.5 mg.',
    route: 'IV/IO',
    tint: '#FFA000',
